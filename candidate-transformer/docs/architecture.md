...
* Claim {  
*   entity\_key:   str        \# provisional per-record grouping key (pre-resolution)  
*   field\_path:   str        \# canonical field this asserts, e.g. "full\_name", "emails"  
*   value:        Any        \# normalized value (post-normalization)  
*   raw\_value:    Any        \# original, for provenance/debugging  
*   source:       str        \# "ats" | "csv" | "github" | "notes"  
*   method:       str        \# how it was extracted (see methods below)  
*   source\_trust: float      \# from the trust table (§7), stamped at emit time  
* }
